...
public final class Logger {
    ...
    public static final boolean LOG_TRUE = true;
    ...
    public static void plant(@NotNull Timber.Tree tree) {
//        if (tree == null) {
...
//        }
    ...
    private static final List<Timber.Tree> FOREST = new ArrayList<>();
    static Timber.Tree[] forestAsArray = TREE_ARRAY_EMPTY;
    ...
    public static void init() {
        if (Logger.LOG_TRUE && BuildConfig.DEBUG) {
            Logger.plant(getTimberDebugTree());
            Timber.plant(getTimberDebugTree());
        }
    }

    protected static Timber.Tree getTimberDebugTree() {
        return new MyDebugTree(BuildConfig.VERSION_CODE);
    }

    public static class MyDebugTree extends Timber.DebugTree {

        private static final String NAME = "kiwiplay";
        private final int ver;

        public MyDebugTree(int ver) {
            this.ver = ver;
        }

        @Override
        protected String createStackElementTag(StackTraceElement element) {
            return String.format("[%s.%d.%s.%s/%s]", NAME, this.ver, super.createStackElementTag(element), element.getMethodName(), element.getLineNumber());
        }
